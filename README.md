...
```bash
wget -qO- https://raw.githubusercontent.com/Alaxay8/DPIReverse/v1.0.1/scripts/install.sh | bash
```

### One-liner Uninstallation

```bash
wget -qO- https://raw.githubusercontent.com/Alaxay8/DPIReverse/v1.0.1/scripts/uninstall.sh | bash
```
